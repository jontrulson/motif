/* $XConsortium: InputMethod1.c /main/5 1995/07/15 21:00:35 drk $ */
/*
 * Motif
 *
...
/*    XtSetArg(args[n], XmNfontList, big_fontlist);               n++; */
    ...
    /* Test that we really have a shared Input Context */
	...
	printf("\nText widgets are sharing the Input Context\n");
    else
	printf("\nERROR: Text widgets are not sharing the Input Context\n");
