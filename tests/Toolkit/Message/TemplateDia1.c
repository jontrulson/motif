/* $XConsortium: TemplateDia1.c /main/4 1995/07/15 21:07:10 drk $ */
/*
 * Motif
 *
...
char **argv;
{
    ...
    mbox = (XmMessageBoxWidget)XmCreateTemplateDialog (Shell1, "template", args, n);
    ...
    n = 0;
    string = XmStringCreateSimple ("Crepuscule for Nellie");
    ...
    n = 0;
    tinaPix = CreatePixmap (XtScreen(mbox), tinaBits, 75, 75,
