...
char **argv;
{
    ...
    str1 = XmStringCreate ("B&Whour",  XmSTRING_DEFAULT_CHARSET);
    str2 = XmStringCreate ("NoMinimize",  XmSTRING_DEFAULT_CHARSET);
    str3 = XmStringCreate ("defaultIcon",  XmSTRING_DEFAULT_CHARSET);
    str4 = XmStringCreate ("tinaIcon",  XmSTRING_DEFAULT_CHARSET);
