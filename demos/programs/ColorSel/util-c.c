 ...
 *	
 * Edit the file ${}/gen/utils.c ($SYSTEM:[gen]utils.c on VMS) to
 * make system wide changes to this file which will be visible next time
 * this file is generated. 
 * ${} is the directory where Builder Xcessory is installed.
 */

/*
 *  supplies a string format for compound strings:
 *
 *		::[#tag][:t][:r]["str"]
 *
 * where:
...
#endif /* __FIND_TOP_SHELL */

/*
 * Function:
 *	WidgetIdsFromNames(ref, cbName, stringList)
 * Description:
